...
\
ule{\\linewidth}{0.5pt}\\\\[0.5cm]
{\\huge\\bfseries Safe-Concurrency for\\\\Multi-Sensor Fusion in\\\\Industrial Safety-Critical Systems\\\\[0.2cm]}
{\\Large\\bfseries v3.0 — N-Sensor + Adaptive Lockout + Event-Triggered + Power Mgmt\\\\[0.5cm]}
\
ule{\\linewidth}{0.5pt}\\\\[1.5cm]
...
\hline
Durasi lockout & 500 ms (Minor) / 2000 ms (Critical) \\\\
\hline
