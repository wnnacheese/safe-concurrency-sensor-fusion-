...
Sejauh penelusuran literatur, belum ada penelitian yang mengkombinasikan: (a) Rust bare-metal pada ESP32-S3 (Xtensa LX7), (b) \texttt{Mutex<RefCell<T>{}>} + \texttt{critical\_section} untuk concurrency, (c) voting-based N-sensor fusion dengan majority quorum, (d) adaptive lockout berdasarkan fault severity, (e) event-triggered architecture untuk efisiensi CPU, dan (f) power management dengan RTC light-sleep --- dalam satu sistem terintegrasi. Metode ini menjembatani celah antara riset formal verification Rust (J19, J23) dengan implementasi praktis pada embedded system. Versi v3.0 menambahkan skalabilitas N-sensor, klasifikasi severity fault, dan manajemen daya untuk deployment industri nyata.
